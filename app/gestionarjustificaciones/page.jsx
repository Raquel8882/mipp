...
export default function GestionarJustificacionesPage(){
  ...
  return (
    <div style={{ maxWidth: 1000, margin: '2rem auto', padding: 24 }}>
      ...
      <h2>Gestionar justificaciones (Pendientes)</h2>
                ...
                {rows.map(r => {
                  ...
                  return (
                    <tr key={r.id} style={{ borderBottom:'1px solid #eee' }}>
                      ...
                      <td style={{ padding:8 }}>{r.tipo_justificacion || 'Justificación'}</td>
                      <td style={{ padding:8 }}>
                        <Link href={`/justificaciones/${r.id}`}>Abrir</Link>
                        {' '}|{' '}
                        <Link href={`/justificaciones/${r.id}/responder`} style={{ color:'#2563eb' }}>Responder</Link>
                      </td>
                    </tr>
                  );
                })}
